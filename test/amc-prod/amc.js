...
//  reg-cli ./test/amc/main_screen/desktop_chrome/ ./test/amc-prod/screen/actual/desktop_chrome/ ./test/amc-prod/screen/diff1 -R ./test/amc-prod/amc-prod-report.html
//npm run de
...
describe('Log in ', () => {
    it('Log in AMC on show detail', () => {
        browser.url('https://www.amcnconnect.com/premium-originals/show-15-copy-copy/');
        browser.setTimeout({
            'pageLoad': 10000,
            'script': 70000});
...
describe('Dashboard ', () => {
    it('check my acc', () => {
        browser.url('https://www.amcnconnect.com/premium-originals/show-15-copy-copy//my-account/');
        browser.setTimeout({
            'pageLoad': 10000,
            'script': 70000});
        browser.setWindowSize(1980, 1050);
